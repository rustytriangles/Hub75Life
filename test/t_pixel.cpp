...
//    REQUIRE(hsv_to_rgb(0.166667f, 1.f, 1.f) == Pixel(1.f, 1.f, 0.f)); // off-by-one
...
//    REQUIRE(hsv_to_rgb(0.833333f, 1.f, 1.f) == Pixel(1.f, 0.f, 1.f)); // off-by-one
    REQUIRE(hsv_to_rgb(1.f      , 1.f, 1.f) == Pixel(1.f, 0.f, 0.f));

    // saturation == 1/2
    REQUIRE(hsv_to_rgb(0.f      , 0.5f, 1.f) == Pixel(1.f , 0.5f, 0.5f));
//    REQUIRE(hsv_to_rgb(0.166667f, 0.5f, 1.f) == Pixel(1.f, 1.f, 0.5f)); // off-by-one
...
//    REQUIRE(hsv_to_rgb(0.833333f, 0.5f, 1.f) == Pixel(1.f, 0.5f, 1.f)); // off-by-one
